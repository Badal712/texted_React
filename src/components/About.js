        ...
        <div className="accordion" id="accordionExample" >
            <div className="accordion-item" style={{backgroundColor : props.mode === 'dark'?'white':'black', color : props.mode === 'light'?'black':'white'}} >
                ...
                <div id="collapseOne" className="accordion-collapse collapse show"  data-bs-parent="#accordionExample">
                    <div className="accordion-body" style={{backgroundColor : props.mode === 'light'?'white':'Black', color : props.mode === 'light'?'black':'white'}}>
                        <strong>Welcome to TextED,</strong> where we transform ordinary text into extraordinary expressions! Our mission is to provide you with the tools and resources to enhance your<code> text creatively and efficiently.</code>,<br/><br/>
            ...
            <div className="accordion-item" style={{backgroundColor : props.mode === 'light'?'white':'Black', color : props.mode === 'light'?'black':'white'}}>
                ...
                <div id="collapseTwo" className="accordion-collapse collapse"  data-bs-parent="#accordionExample">
                    <div className="accordion-body" style={{backgroundColor : props.mode === 'light'?'white':'Black', color : props.mode === 'light'?'black':'white'}}>
                        At TextED, our vision is to empower individuals and businesses to express themselves creatively through text. We envision a world where text is not just a means of communication, but a form of art that inspires, captivates, and resonates with audiences around the globe.<br/><br/>
                        ...
                        Join us in shaping the future of TextED and let's create something extraordinary, one word at a time.
                    </div>
                </div>
            </div>
            <div className="accordion-item" style={{backgroundColor : props.mode === 'light'?'white':'Black', color : props.mode === 'light'?'black':'white'}}>
                ...
                <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body">
                        ...
                        At TextED, we believe that every word matters, and our mission is to help you make every word count. Join us on our mission to revolutionize text modification and unlock the full potential of your communication.
                    </div>
                </div>
            </div>
        </div>
